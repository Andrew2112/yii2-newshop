...
<div class="agileits_header">
    <div class="w3l_offers">
        <a href="<?=\yii\helpers\Url::to(['hotoffers/offers'])?>">Today's special Offers !</a>
    </div>
    ...
    <div class="product_list_header">
        ...
        <button onclick="getCart()" type="button" class="button" data-toggle="modal" data-target="#modal-cart">
            <span class="cart-sum">$ <?=isset($_SESSION['cart.sum']) ? $_SESSION['cart.sum'] : '0'; ?></span>
        </button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?=\yii\helpers\Url::to('cart/checkout')?>" type="button" class="btn btn-primary">Оформить заказ</a>
    ...
    <div class="container">
        ...
        <div class="w3ls_logo_products_left1">
            <ul class="special_items">
                ...
                <li><a href="<?= \yii\helpers\Url::to(['about'])?>">About Us</a><i>/</i></li>
