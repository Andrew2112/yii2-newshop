                ...
                <ul class="slides">
                    <li>
                        <div class="w3l_banner_nav_right_banner">
                            ...
                            <div class="more">
                                <a href="<?=\yii\helpers\Url::to(['hotoffers/offers'])?>" class="button--saqui button--round-l button--text-thick"
                        ...
                        <div class="hover14 column">
                            <div class="agile_top_brand_left_grid">
                                <div class="agile_top_brand_left_grid_pos">
                                    <?= Html::img('@web/images/offer.png', ['alt' => 'Наше предложение', 'class' => "img-responsive"]) ?>
                                </div>
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                ...
                                                <h4>$ <?= $value->price; ?>
                                                    <span>
                                                        <?php if ((float)$value->old_price > 0) echo '$' . $value->old_price; ?>
                                                    </span></h4>
                                            </div>
